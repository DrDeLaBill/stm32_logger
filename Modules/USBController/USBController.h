...
private:
    using hid_table_t = HIDTable<
        ...
        HIDTuple<uint16_t, SettingsInterface::modbus1_status>,
        HIDTuple<uint16_t, SettingsInterface::modbus1_value_reg>,
        HIDTuple<uint16_t, SettingsInterface::modbus1_id_reg>,
